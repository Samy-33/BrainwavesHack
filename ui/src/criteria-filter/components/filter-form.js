...
import { Button, Col, Collapse, Form, Row, FormGroup, Label, Input } from 'reactstrap'
...
class FilterForm extends React.Component {
    ...
    handleQuerySubmit = () => {
        this.props.load_filtered_data_for_queries({...this.state})
    }

    handleMatchedDetails = (message_id) => {
    ...
    render () {
        return (
            <div>
                <div className="d-flex flex-row-reverse"><Button onClick={()=>this.setState({...this.state, collapse: !this.state.collapse})} >Toggle Filters</Button></div>
                <Collapse isOpen={this.state.collapse}>
                    <Form>
                        ...
                        <Row form>
                            {/* <Col md={6}>
                                <FormGroup>
                                    <Label for="tradeDate">Trade Date From: </Label>
                                    <Input type="date" placeholder="DD/MM/YYYY" id="tradeDate"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="tradeDateStart"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="tradeDateEnd"
                        ...
                        <Row form>
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="settlementDateStart"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="settlementDateEnd"
                        ...
                        <Row form>
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="fixingDateStart"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="date" placeholder="DD/MM/YYYY" id="fixingDateEnd"
                        ...
                        <Row form>
                            <Col md={2}>
                                <FormGroup>
                                    ...
                                    <Input type="select" id="sellCurrency" value={this.state.sell_currency} onChange={(e)=>this.setState({...this.state, sell_currency: e.target.value})}>
                                        {currencies.map((currency, ind) => {
                                            return <option key={ind}>{currency}</option>
                                        })}
                                    </Input>
                        ...
                        <Row form>
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="number" placeholder="xxxx.xx" step="0.01" id="rateStart"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <Input type="number" placeholder="xxxx.xx" step="0.01" id="rateEnd"
                    ...
                    <br />
                    <Button disabled={this.props.dataLoading} color="success" onClick={()=>this.handleQuerySubmit()} block>Get Data</Button>
                </Collapse>
...
const mapStateToProps = ({criteria: {dataLoading}}) => ({dataLoading})
const mapDispatchToProps = {load_filtered_data_for_queries}
